  ...
  return (
    <HomeStyle>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input type="text" name="password" placeholder="비밀번호 (8자 이상)" />
        <input type="text" name="password-check" placeholder="비밀번호 확인" />
        ...
        <input type="number" placeholder="개인신용점수" />
        <select name="loan" id="">
