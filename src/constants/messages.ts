export const MESSAGES = {
  ...
  PRODUCT: {
    ERROR_GET_DETAIL: '상품상세 조회 중 에러가 발생했습니다.',
  },
  CART: {
    CHECK_DELETE: '선택하신 상품을 삭제하시겠습니까?',
    COMPLETE_DELETE: '삭제가 완료되었습니다.',
    COMPLETE_ADD: '장바구니에 추가되었습니다.',
    ERROR_GET: '장바구니 조회 중 에러가 발생했습니다.',
    ERROR_CREATE: '장바구니 추가 중 에러가 발생했습니다.',
    ERROR_UPDATE: '장바구니 수정 중 에러가 발생했습니다.',
    ERROR_DELETE: '장바구니 삭제 중 에러가 발생했습니다.',
  },
  BUY: {
